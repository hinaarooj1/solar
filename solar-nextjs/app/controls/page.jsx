                        ...
                        <CardContent sx={{ p: { xs: 2, sm: 3 } }}>
                            ...
                            {isLoadingHealth ? (
                                ...
                                <>
                                        ...
                                        <Grid item xs={6} sm={6}>
                                            <Box sx={{ 
                                                ...
                                                <Typography variant="h6" sx={{ fontWeight: 600, fontSize: { xs: '1rem', sm: '1.25rem' } }}>
                                                    {systemHealth.utility_ac_voltage}V
                                                </Typography>
                                            </Box>
                                        </Grid>
                                        <Grid item xs={6} sm={6}>
                                    ...
                                    <Box sx={{ mt: 2, p: 2, background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.03)', borderRadius: 2 }}>
                                        <Typography variant="body2" sx={{ opacity: 0.7 }}>
                                            Mode: <strong>{systemHealth.system_mode}</strong>
                                        </Typography>
