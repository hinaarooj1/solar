...
// Copy this file to constants.js and update with your settings
...
const API_URLS = {
    ...
    // production: 'https://your-backend-url.onrender.com' // Your production API URL
    production: 'https://analytixcoin.onrender.com' // Your production API URL
};
